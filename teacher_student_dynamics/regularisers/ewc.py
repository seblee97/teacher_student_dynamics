...
from teacher_student_dynamics.regularisers import base_regulariser
...
class EWC(base_regulariser.BaseRegulariser):
    def compute_first_task_importance(
        ...
        self._new_teacher_index = new_teacher_index
    ...
    def _diag_fisher(self):
        ...
        self._student.signal_boundary(new_head=self._previous_teacher_index)
        ...
        # return back head
        self._student.signal_boundary(new_head=self._new_teacher_index)
